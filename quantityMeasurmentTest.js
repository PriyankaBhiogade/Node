...
let temperatureUnit = require('./temperature');
...
describe(`Temperature Unit validation Test`, () => {
    it(`given 212F And 100C When Equal should return true `, () => {
        let fahrenheit = quantityMeasurment.compareTemperatureUnits(temperatureUnit.temperatureEnum.FAHRENHEIT, 212);
        let celsius = quantityMeasurment.compareTemperatureUnits(temperatureUnit.temperatureEnum.CELSIUS, 100);
